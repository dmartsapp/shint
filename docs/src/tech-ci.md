...
<svg viewBox="0 0 700 300" role="img" aria-label="Workflow graph: one tag push starts five workflows">
  ...
  <text class="sub" x="75" y="164" text-anchor="middle">v4.0.4</text>
...
| Compute tags | From the tag `v4.0.4`: `v4.0.4`, `4.0.4`, `4.0`, `4`, and `latest`. |
...
gh release view v4.0.4                      # the release and its assets
```
