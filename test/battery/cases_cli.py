...
for cid, extra, rc in [
    ...
    ("timeout-abc", ["--timeout", "abc"], 2), ("timeout-int64max", ["--timeout", "9223372036854775807"], 0),
    ("timeout-2^31", ["--timeout", "2147483648"], 0), ("timeout-3600", ["--timeout", "3600"], 0),
    ("timeout-10^10", ["--timeout", "10000000000"], 0),
    ("delay-neg", ["--delay", "-1"], None), ("delay-abc", ["--delay", "abc"], 2), ("delay-float", ["--delay", "1.5"], 2),
    ("delay-int64max-count1", ["--delay", "9223372036854775807"], None),
